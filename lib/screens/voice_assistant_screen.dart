...
if (available) {
  await speech.listen(
    onResult: (result) {
      ...
      // QR VERIFICATION
      else if (command.contains("verification") ||
          command.contains("qr")) {
        Navigator.push(
          context,
          MaterialPageRoute(
      ...
      // LEFTOVER FERTILIZER
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (_) =>
                const LeftoverFertilizerSellingScreen(),
          ),
        );
      }

      // LABOUR
      else if (command.contains("labour") ||
          command.contains("labor")) {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) =>
                const LabourHiringScreen(),
          ),
        );
      }
